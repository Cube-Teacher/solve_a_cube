...
for it in range(0,4):#完成邊塊
    ...
    if(initial_color[0][7]==color1 and initial_color[1][1]==color2):
        operation=['白'+string+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[1][1]==color1 and initial_color[0][7]==color2):
        operation=['白'+string+'邊塊在正確位置 但方向錯誤',7,14,2,13,'白'+string+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[3][3]==color1 and initial_color[1][5]==color2):
        operation=['白'+string+'邊塊在前面右側',8,'白'+string+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[1][5]==color1 and initial_color[3][3]==color2):
        operation=['白'+string+'邊塊在前面右側',14,2,13,'白'+string+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[4][5]==color1 and initial_color[1][3]==color2):
        operation=['白'+string+'邊塊在前面左側',7,'白'+string+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[1][3]==color1 and initial_color[4][5]==color2):
        operation=['白'+string+'邊塊在前面左側',13,4,14,'白'+string+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[5][1]==color1 and initial_color[1][7]==color2):
        operation=['白'+string+'邊塊在前面下方',7,7,'白'+string+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[1][7]==color1 and initial_color[5][1]==color2):
        operation=['白'+string+'邊塊在前面下方',7,13,4,14,'白'+string+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[0][5]==color1 and initial_color[3][1]==color2):
        operation=['白'+string+'邊塊在上面右側',1,14,2,13,'白'+string+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[3][1]==color1 and initial_color[0][5]==color2):
        operation=['白'+string+'邊塊在上面右側',1,8,'白'+string+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[2][3]==color1 and initial_color[3][5]==color2):
        operation=['白'+string+'邊塊在右側面',19,'白'+string+'邊塊在前面右側',14,8,13,'回到左側面',20,'白'+string+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[3][5]==color1 and initial_color[2][3]==color2):
        operation=['白'+string+'邊塊在右側面',19,'白'+string+'邊塊在前面右側',14,14,2,13,13,'回到左側面',20,'白'+string+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[5][5]==color1 and initial_color[3][7]==color2):
        operation=['白'+string+'邊塊在右側面',19,'白'+string+'邊塊在前面下方',14,7,7,13,'回到左側面',20,'白'+string+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[3][7]==color1 and initial_color[5][5]==color2):
        operation=['白'+string+'邊塊在右側面',19,'白'+string+'邊塊在前面下方',14,7,13,4,'回到左側面',20,'白'+string+'邊塊已在正確位置 往右進行下一步',19]        
    elif(initial_color[0][3]==color1 and initial_color[4][1]==color2):
        operation=['白'+string+'邊塊在上面左側',14,'白'+string+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[4][1]==color1 and initial_color[0][3]==color2):
        operation=['白'+string+'邊塊在上面左側',3,7,'白'+string+'邊塊已在正確位置 往右進行下一步',19]       
    elif(initial_color[2][5]==color1 and initial_color[4][3]==color2):
        operation=['白'+string+'邊塊在左側面',20,'白'+string+'邊塊在前面左側',13,7,14,'回到右側面',19,'白'+string+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[4][3]==color1 and initial_color[2][5]==color2):
        operation=['白'+string+'邊塊在左側面',20,'白'+string+'邊塊在前面左側',13,13,4,14,14,'回到右側面',19,'白'+string+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[5][3]==color1 and initial_color[4][7]==color2):
        operation=['白'+string+'邊塊在左側面',20,'白'+string+'邊塊在前面下方',13,7,7,14,'回到右側面',19,'白'+string+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[4][7]==color1 and initial_color[5][3]==color2):
        operation=['白'+string+'邊塊在左側面',20,'白'+string+'邊塊在前面下方',13,8,14,2,'回到右側面',19,'白'+string+'邊塊已在正確位置 往右進行下一步',19]        
    elif(initial_color[0][1]==color1 and initial_color[2][1]==color2):
        operation=['白'+string+'邊塊在上面上方',3,13,13,4,'白'+string+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[2][1]==color1 and initial_color[0][1]==color2):
        operation=['白'+string+'邊塊在後面',20,20,'白'+string+'邊塊在前面上方',7,13,2,14,'回到前面',19,19,'白'+string+'邊塊已在正確位置 往右進行下一步',19]        
    elif(initial_color[5][7]==color1 and initial_color[2][7]==color2):
        operation=['白'+string+'邊塊在後面',20,20,'白'+string+'邊塊在前面下方',14,14,7,7,14,14,'回到前面',19,19,'白'+string+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[2][7]==color1 and initial_color[5][7]==color2):
        operation=['白藍'+string+'塊在後面',20,20,'白'+string+'邊塊在前面下方',14,14,7,13,4,13,'回到前面',19,19,'白'+string+'邊塊已在正確位置 往右進行下一步',19]
...
for it in range(0,4):#完成角塊
    ...
    if(initial_color[0][8]==color1):
        operation=['白'+string1+string2+'角塊已在正確位置 往右進行下一步',19]
    elif(initial_color[1][2]==color1):
        operation=['白'+string1+string2+'角塊在右上角 用角塊右四步法 將白'+string1+string2+'角塊轉至右下角',
                   2,8,1,7,'白'+string1+string2+'角塊在右下角 用角塊右四步法 將白'+string1+string2+'角塊轉至正確位置',
                   2,8,1,7,'白'+string1+string2+'角塊已在正確位置 往右進行下一步',19]
    elif(initial_color[3][0]==color1):
        operation=['白'+string1+string2+'角塊在右側面',19,'白'+string1+string2+'角塊在左上角 用角塊左四步法 將白'+string1+string2+'角塊轉至左下角',
                   4,7,3,8,'白'+string1+string2+'角塊在左下角 用角塊左四步法 將白'+string1+string2+'角塊轉至正確位置',
                   4,7,3,8,'回到左側面',20,'白'+string1+string2+'角塊已在正確位置 往右進行下一步',19]
        
    elif(initial_color[1][8]==color1):
        operation=['白'+string1+string2+'角塊在右下角 用角塊右四步法 將白'+string1+string2+'角塊轉至正確位置',
                   2,8,1,7,'白'+string1+string2+'角塊已在正確位置 往右進行下一步',19]
    elif(initial_color[5][2]==color1):
        operation=['白'+string1+string2+'角塊在底面右邊 用角塊右四步法 將白'+string1+string2+'角塊轉至右上角',
                   2,8,1,7,'白'+string1+string2+'角塊在右上角 用角塊右四步法 將白'+string1+string2+'角塊轉至右下角',
                   2,8,1,7,'白'+string1+string2+'角塊在右下角 用角塊右四步法 將白'+string1+string2+'角塊轉至正確位置',
                   2,8,1,7,'白'+string1+string2+'角塊已在正確位置 往右進行下一步',19]
    elif(initial_color[3][6]==color1):
        operation=['白'+string1+string2+'角塊在右側面',19,'白'+string1+string2+'角塊在左下角 用角塊左四步法 將白'+string1+string2+'角塊轉至正確位置',
                   4,7,3,8,'回到左側面',20,'白'+string1+string2+'角塊已在正確位置 往右進行下一步',19]
        
    elif(initial_color[0][6]==color1):
        operation=['白'+string1+string2+'角塊在上面左邊 用角塊左四步法 將白'+string1+string2+'角塊轉下來',
                   4,7,3,8,'白'+string1+string2+'角塊在左側面',20,'右轉對齊',13,
                   '白'+string1+string2+'角塊在右下角 用角塊右四步法 將白'+string1+string2+'角塊轉至正確位置',
                   2,8,1,7,'左轉歸位',14,'回到右側面',19,'白'+string1+string2+'角塊已在正確位置 往右進行下一步',19]
    elif(initial_color[1][0]==color1):
        operation=['白'+string1+string2+'角塊在左上角 用角塊左四步法 將白'+string1+string2+'角塊轉至左下角',
                   4,7,3,8,'右轉對齊',13,'白'+string1+string2+'角塊在左下角 用角塊左四步法 將白'+string1+string2+'角塊轉至正確位置',
                   4,7,3,8,'左轉歸位',14,'白'+string1+string2+'角塊已在正確位置 往右進行下一步',19]
    elif(initial_color[4][2]==color1):
        operation=['白'+string1+string2+'角塊在左側面',20,'白'+string1+string2+'角塊在右上角 用角塊右四步法 將白'+string1+string2+'角塊轉至右下角',
                   2,8,1,7,'右轉對齊',13,'白'+string1+string2+'角塊在右下角 用角塊右四步法 將白'+string1+string2+'角塊轉至正確位置',
                   2,8,1,7,'左轉歸位',14,'回到右側面',19,'白'+string1+string2+'角塊已在正確位置 往右進行下一步',19]
        
    elif(initial_color[1][6]==color1):
        operation=['右轉對齊',13,'白'+string1+string2+'角塊在左下角 用角塊左四步法 將白'+string1+string2+'角塊轉至正確位置',
                   4,7,3,8,'左轉歸位',14,'白'+string1+string2+'角塊已在正確位置 往右進行下一步',19]
    elif(initial_color[5][0]==color1):
        operation=['右轉對齊',13,'白'+string1+string2+'角塊在底面左邊 用角塊右四步法 將白'+string1+string2+'角塊轉至左上角',
                   4,7,3,8,'白'+string1+string2+'角塊在左上角 用角塊左四步法 將白'+string1+string2+'角塊轉至左下角',
                   4,7,3,8,'白'+string1+string2+'角塊在左下角 用角塊左四步法 將白'+string1+string2+'角塊轉至正確位置',
                   4,7,3,8,'左轉歸位',14,'白'+string1+string2+'角塊已在正確位置 往右進行下一步',19]
    elif(initial_color[4][8]==color1):
        operation=['白'+string1+string2+'角塊在左側面',20,'右轉對齊',13,'白'+string1+string2+'角塊在右下角 用角塊右四步法 將白'+string1+string2+'角塊轉至正確位置',
                   2,8,1,7,'左轉歸位',14,'回到右側面',19,'白'+string1+string2+'角塊已在正確位置 往右進行下一步',19]#
        
    elif(initial_color[0][0]==color1):
        operation=['白'+string1+string2+'角塊在後面',20,20,
                   '白'+string1+string2+'角塊在上面右邊 用角塊右四步法 將白'+string1+string2+'角塊轉下來',
                   2,8,1,7,'白'+string1+string2+'角塊在右側面',19,'右轉對齊',13,13,
                   '白'+string1+string2+'角塊在左下角 用角塊左四步法 將白'+string1+string2+'角塊轉至正確位置',
                   4,7,3,8,'左轉歸位',14,14,'回到右側面',19,'白'+string1+string2+'角塊已在正確位置 往右進行下一步',19]
    elif(initial_color[2][2]==color1):
        operation=['白'+string1+string2+'角塊在後面',20,20,
                   '白'+string1+string2+'角塊在右上角 用角塊右四步法 將白'+string1+string2+'角塊轉至右下角',
                   2,8,1,7,'右轉對齊',13,13,'白'+string1+string2+'角塊在右下角 用角塊右四步法 將白'+string1+string2+'角塊轉至正確位置',
                   2,8,1,7,'左轉歸位',14,14,'回到前面',19,19,'白'+string1+string2+'角塊已在正確位置 往右進行下一步',19]
    elif(initial_color[4][0]==color1):
        operation=['白'+string1+string2+'角塊在左側面',20,
                   '白'+string1+string2+'角塊在左上角 用角塊左四步法 將白'+string1+string2+'角塊轉至左下角',
                   4,7,3,8,'右轉對齊',13,13,'白'+string1+string2+'角塊在左下角 用角塊左四步法 將白'+string1+string2+'角塊轉至正確位置',
                   4,7,3,8,'左轉歸位',14,14,'回到右側面',19,'白'+string1+string2+'角塊已在正確位置 往右進行下一步',19]
        ...
        operation=['白'+string1+string2+'角塊在後面',20,20,'右轉對齊',13,13,
                   '白'+string1+string2+'角塊在底面右邊 用角塊右四步法 將白'+string1+string2+'角塊轉至右上角',
                   2,8,1,7,'白'+string1+string2+'角塊在右上角 用角塊右四步法 將白'+string1+string2+'角塊轉至右下角',
                   2,8,1,7,'白'+string1+string2+'角塊在右下角 用角塊右四步法 將白'+string1+string2+'角塊轉至正確位置',
                   2,8,1,7,'左轉歸位',14,14,'回到前面',19,19,'白'+string1+string2+'角塊已在正確位置 往右進行下一步',19]
        ...
        operation=['白'+string1+string2+'角塊在後面',19,19,
                   '白'+string1+string2+'角塊在上面左邊 用角塊左四步法 將白'+string1+string2+'角塊轉下來',
                   4,7,3,8,'白'+string1+string2+'角塊在左側面',20,'左轉對齊',14,
                   '白'+string1+string2+'角塊在右下角 用角塊右四步法 將白'+string1+string2+'角塊轉至正確位置',
                   2,8,1,7,'右轉歸位',13,'回到左側面',20,'白'+string1+string2+'角塊已在正確位置 往右進行下一步',19]
    elif(initial_color[2][0]==color1):
        operation=['白'+string1+string2+'角塊在後面',19,19,
                   '白'+string1+string2+'角塊在左上角 用角塊左四步法 將白'+string1+string2+'角塊轉至左下角',
                   4,7,3,8,'左轉對齊',14,
                   '白'+string1+string2+'角塊在左下角 用角塊左四步法 將白'+string1+string2+'角塊轉至正確位置',
                   4,7,3,8,'右轉歸位',13,'回到前面',20,20,'白'+string1+string2+'角塊已在正確位置 往右進行下一步',19]
        ...
        operation=['白'+string1+string2+'角塊在後面',19,19,'左轉對齊',14,
                   '白'+string1+string2+'角塊在底面左邊 用角塊右四步法 將白'+string1+string2+'角塊轉至左上角',
                   4,7,3,8, '白'+string1+string2+'角塊在左上角 用角塊左四步法 將白'+string1+string2+'角塊轉至左下角',
                   4,7,3,8, '白'+string1+string2+'角塊在左下角 用角塊左四步法 將白'+string1+string2+'角塊轉至正確位置',
                   4,7,3,8,'右轉歸位',13,'回到前面',20,20,'白'+string1+string2+'角塊已在正確位置 往右進行下一步',19]
...
for it in range(0,4):
    ...
    if(initial_color[1][1]==color1):
        operation=['用右邊塊八步法 將'+string1+string2+'轉至正確位置',13,2,14,1,14,8,13,7,string1+string2+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[4][1]==color1):
        operation=[string1+string2+'邊塊在左方',14,'用右邊塊八步法 將'+string1+string2+'轉至正確位置',
                   13,2,14,1,14,8,13,7,string1+string2+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[2][1]==color1):
        operation=[string1+string2+'邊塊在後方',14,14,'用右邊塊八步法 將'+string1+string2+'轉至正確位置',
                   13,2,14,1,14,8,13,7,string1+string2+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[3][1]==color1):
        operation=[string1+string2+'邊塊在右方',13,'用右邊塊八步法 將'+string1+string2+'轉至正確位置',
                   13,2,14,1,14,8,13,7,string1+string2+'邊塊已在正確位置 往右進行下一步',19]
        
    elif(initial_color[0][7]==color1):
        operation=['翻至右側面準備',19,string1+string2+'邊塊在左方',14,'用左邊塊八步法 將'+string1+string2+'轉至正確位置',
                   14,4,13,3,13,7,14,8,'回到左側面',20,string1+string2+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[0][5]==color1):
        operation=['翻至右側面準備',19,'用左邊塊八步法 將'+string1+string2+'轉至正確位置',
                   14,4,13,3,13,7,14,8,'回到左側面',20,string1+string2+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[0][1]==color1):
        operation=['翻至右側面準備',19,string1+string2+'邊塊在右方',13,'用左邊塊八步法 將'+string1+string2+'轉至正確位置',
                   14,4,13,3,13,7,14,8,'回到左側面',20,string1+string2+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[0][3]==color1):
        operation=['翻至右側面準備',19,string1+string2+'邊塊在後方',13,13,'用左邊塊八步法 將'+string1+string2+'轉至正確位置',
                   14,4,13,3,13,7,14,8,'回到左側面',20,string1+string2+'邊塊已在正確位置 往右進行下一步',19]
        
    elif(initial_color[1][5]==color1):
        operation=[string1+string2+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[3][5]==color1):
        operation=[string1+string2+'邊塊在右側面',19,string1+string2+'邊塊在別人家 用右邊塊八步法將其轉出來',
                   13,2,14,1,14,8,13,7,string1+string2+'邊塊在後方',13,13,
                   '用左邊塊八步法 將'+string1+string2+'轉至正確位置',
                   14,4,13,3,13,7,14,8,'回到左側面',20,string1+string2+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[2][5]==color1):
        operation=[string1+string2+'邊塊在後面',19,19,string1+string2+'邊塊在別人家 用右邊塊八步法將其轉出來',
                   13,2,14,1,14,8,13,7,'翻至左側面準備',20,string1+string2+'邊塊在左方',14,
                   '用左邊塊八步法 將'+string1+string2+'轉至正確位置',
                   14,4,13,3,13,7,14,8,'回到左側面',20,string1+string2+'邊塊已在正確位置 往右進行下一步',19]
    elif(initial_color[4][5]==color1):
        operation=[string1+string2+'邊塊在左側面',20,string1+string2+'邊塊在別人家 用右邊塊八步法將其轉出來',
                   13,2,14,1,14,8,13,7,'翻至後面準備',19,19,
                   '用左邊塊八步法 將'+string1+string2+'轉至正確位置',
                   14,4,13,3,13,7,14,8,'回到左側面',20,string1+string2+'邊塊已在正確位置 往右進行下一步',19]
        
    elif(initial_color[3][3]==color1):
        operation=[string1+string2+'邊塊在正確位置 但方向錯誤 用右邊塊八步法將其轉出來',
                   13,2,14,1,14,8,13,7,string1+string2+'邊塊在後方',13,13,
                   '用右邊塊八步法 將'+string1+string2+'轉至正確位置',
                   13,2,14,1,14,8,13,7,string1+string2+'邊塊已在正確位置 往右進行下一步',19]
        ...
        operation=[string1+string2+'邊塊在左側面',20,string1+string2+'邊塊在別人家 用右邊塊八步法將其轉出來',
                   13,2,14,1,14,8,13,7,'翻至右側面準備',19,'邊塊在右方',13,
                   '用右邊塊八步法 將'+string1+string2+'轉至正確位置',
                   13,2,14,1,14,8,13,7,string1+string2+'邊塊已在正確位置 往右進行下一步',19]
...
while (1):#頂面角塊都不是黃色
    ...
    operation=['使用六步法 讓頂面角塊出現兩個黃色',1,14,8,13,7,2]
...
while (1):#頂面角塊兩個黃色
    ...
    if(check_if_yellow_edge(initial_color[0][1])==1 and check_if_yellow_edge(initial_color[0][3])==0
      and check_if_yellow_edge(initial_color[0][5])==0 and check_if_yellow_edge(initial_color[0][7])==1):#直線
        check_yellow_flag=1
        operation=['直線型 使用六步法 將黃色角塊變成倒L型',1,14,8,13,7,2]
      ...
      and check_if_yellow_edge(initial_color[0][5])==0 and check_if_yellow_edge(initial_color[0][7])==0):#上左
        check_yellow_flag=1
        operation=['倒L型 使用六步法 讓頂面角塊出現四個黃色',1,14,8,13,7,2]
...
while (1):#頂面邊塊都是黃色
    ...
    if(check_if_yellow_edge(initial_color[1][0])==1 and check_if_yellow_edge(initial_color[1][2])==1
      ...
      and check_if_yellow_edge(initial_color[4][0])==1 and check_if_yellow_edge(initial_color[4][2])==1):#十字
        check_yellow_flag=1
        operation=['十字型 利用七步法 出現魚型',2,14,4,13,1,14,3]
      ...
      and check_if_yellow_edge(initial_color[1][0])==1 and check_if_yellow_edge(initial_color[3][2])==1):#對角
        check_yellow_flag=1
        operation=['對角型 利用七步法 出現魚型',2,14,4,13,1,14,3]
      ...
      and check_if_yellow_edge(initial_color[1][0])==1 and check_if_yellow_edge(initial_color[1][2])==1):#凸型1
        check_yellow_flag=1
        operation=['凸型(兩角塊在一起) 利用七步法 出現魚型',2,14,4,13,1,14,3]
      ...
      and check_if_yellow_edge(initial_color[3][0])==1 and check_if_yellow_edge(initial_color[4][0])==1):#右魚1
        check_yellow_flag=1
        operation=['假魚型(前方右上不是黃色) 利用七步法 出現真魚型',2,14,4,13,1,14,3]
      ...
      and check_if_yellow_edge(initial_color[2][2])==1 and check_if_yellow_edge(initial_color[3][2])==1):#右魚
        check_yellow_flag=1
        operation=['真魚型(前方右上是黃色) 利用七步法 完成第二面',2,14,4,13,1,14,3]
...
while (1):#
    ...
    if(check_blue()==0 and check_green()==0 and check_orange()==0 and check_red()==0):
        check_yellow_flag=1
        operation=['利用十三步法 讓右側兩角塊對調 使同顏色角塊在同一面',2,14,14,1,14,2,14,14,4,13,1,14,3]
...
while (1):#
    ...
    if(check_edge_and_middle(initial_color[1][1],initial_color[1][4])==0 and
       ...
       check_edge_and_middle(initial_color[4][1],initial_color[4][4])==0):
        check_yellow_flag=1
        operation=['四面頂塊未對齊 利用右頂部角塊法 解出第三面',10,10,13,9,13,13,10,13,10,10]
       ...
       check_edge_and_middle(initial_color[4][1],initial_color[4][4])==1):
        ...
        check_yellow_flag=1
        operation=['利用右頂部角塊法 解出魔術方塊',10,10,13,9,13,13,10,13,10,10]
    elif(initial_color[1][4]+3==initial_color[3][1]):
        check_yellow_flag=1
        operation=['利用左頂部角塊法 解出魔術方塊',10,10,14,9,13,13,10,14,10,10]
